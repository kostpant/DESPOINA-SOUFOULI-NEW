 ...
 * 
 * 1. Ανοίξτε τον φάκελο: public/services/womens-cut/work/
 * 2. Ανοίξτε τον φάκελο: public/services/womens-cut/products/
...
export default async function WomensCutPage() {
    const workImages = await getImagesFromFolder("services/womens-cut/work");
    const productImages = await getImagesFromFolder("services/womens-cut/products");
        ...
        <>
            ...
            <section className="min-h-screen bg-white flex items-center justify-center">
                <div className="container mx-auto px-4 md:px-6 max-w-4xl text-center py-32">
                    ...
                    <div className="text-neutral-600 space-y-4 mx-auto max-w-2xl text-lg md:text-xl leading-relaxed">
                        <p>
                            Κουρέματα ακριβείας προσαρμοσμένα στο σχήμα του προσώπου και τον τρόπο ζωής σας. Από κλασικά στυλ έως μοντέρνες τάσεις.
                        </p>
                        <p>
                            Κάθε κούρεμα ξεκινά με μια προσωπική διαβούλευση για να κατανοήσουμε το στυλ σας, δημιουργώντας κουρέματα που φαίνονται υπέροχα και είναι εύκολα στο styling στο σπίτι.
                        </p>
                        <p>
                            Από μακριά μαλλιά με layers έως σύγχρονα bobs και pixie cuts, αναδεικνύουμε τη φυσική σας ομορφιά.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 bg-neutral-50">
                <div className="container mx-auto px-4 md:px-6">
                    <ImageCarousel
                        images={workImages}
                        title="Γυναικεία Κουρέματα"
                        emptyMessage="Προσθέστε φωτογραφίες στον φάκελο public/services/womens-cut/work για να εμφανιστούν εδώ."
                    />
                </div>
            </section>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4 md:px-6">
                    <ImageCarousel
                        ...
                        emptyMessage="Προσθέστε φωτογραφίες στον φάκελο public/services/womens-cut/products για να εμφανιστούν εδώ."
                    />
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    <div className="bg-white rounded-3xl shadow-2xl overflow-hidden p-8 md:p-16 text-center max-w-3xl mx-auto">
                        ...
                        <p className="text-neutral-600 mb-8 text-lg">
                            Κλείστε το ραντεβού σας σήμερα και ανακαλύψτε το τέλειο κούρεμα για εσάς.
                        </p>
