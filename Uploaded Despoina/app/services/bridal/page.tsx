 ...
 * 
 * 1. Ανοίξτε τον φάκελο: public/services/bridal/work/
 * 2. Ανοίξτε τον φάκελο: public/services/bridal/products/
...
export default async function BridalPage() {
    const workImages = await getImagesFromFolder("services/bridal/work");
    const productImages = await getImagesFromFolder("services/bridal/products");
        ...
        <>
            ...
            <section className="min-h-screen bg-white flex items-center justify-center">
                <div className="container mx-auto px-4 md:px-6 max-w-4xl text-center py-32">
                    ...
                    <div className="text-neutral-600 space-y-4 mx-auto max-w-2xl text-lg md:text-xl leading-relaxed">
                        <p>
                            Ολοκληρωμένες νυφικές υπηρεσίες μαλλιών για να εξασφαλίσετε την τέλεια εμφάνιση την πιο ξεχωριστή μέρα σας.
                        </p>
                        <p>
                            Προσφέρουμε πλήρη νυφικά πακέτα που περιλαμβάνουν δοκιμαστικό styling, συμβουλές για το ιδανικό hairstyle που ταιριάζει στο φόρεμα και το στυλ σας.
                        </p>
                        <p>
                            Από κλασικά updos και ρομαντικά κύματα έως σύγχρονα, bohemian styles, δημιουργούμε νυφικά hairstyles που αντέχουν όλη τη μέρα.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 bg-neutral-50">
                <div className="container mx-auto px-4 md:px-6">
                    <ImageCarousel
                        images={workImages}
                        title="Νυφικά Hairstyles"
                        emptyMessage="Προσθέστε φωτογραφίες στον φάκελο public/services/bridal/work για να εμφανιστούν εδώ."
                    />
                </div>
            </section>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4 md:px-6">
                    <ImageCarousel
                        ...
                        emptyMessage="Προσθέστε φωτογραφίες στον φάκελο public/services/bridal/products για να εμφανιστούν εδώ."
                    />
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    <div className="bg-white rounded-3xl shadow-2xl overflow-hidden p-8 md:p-16 text-center max-w-3xl mx-auto">
                        ...
                        <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 text-neutral-900 leading-tight">
                            Κλείστε το νυφικό σας πακέτο
                        </h2>
                        <p className="text-neutral-600 mb-8 text-lg">
                            Επικοινωνήστε μαζί μας σήμερα για να συζητήσουμε τις νυφικές σας ανάγκες.
                        </p>
