 ...
 * 
 * 1. Ανοίξτε τον φάκελο: public/services/balayage/work/
 *    - Σύρετε και αφήστε τις φωτογραφίες των δουλειών Balayage εδώ
 * 
 * 2. Ανοίξτε τον φάκελο: public/services/balayage/products/
 *    - Σύρετε και αφήστε τις φωτογραφίες των προϊόντων εδώ
 * 
 * 3. Υποστηριζόμενες μορφές: .jpg, .jpeg, .png, .webp, .avif
 * 
 * 4. Οι φωτογραφίες θα εμφανιστούν αυτόματα στην ιστοσελίδα
 *    μετά την επανεκκίνηση του διακομιστή (npm run dev)
 */
...
export default async function BalayagePage() {
    const workImages = await getImagesFromFolder("services/balayage/work");
    const productImages = await getImagesFromFolder("services/balayage/products");
        ...
        <>
            ...
            <section className="min-h-screen bg-white flex items-center justify-center">
                <div className="container mx-auto px-4 md:px-6 max-w-4xl text-center py-32">
                    ...
                    <h1 className="text-5xl md:text-7xl font-serif font-bold mb-8 text-neutral-900 leading-tight">
                        Balayage &amp; Τεχνικές Χρώματος
                    </h1>
                    <div className="prose prose-lg text-neutral-600 space-y-4 mx-auto max-w-2xl text-lg md:text-xl leading-relaxed">
                        <p>
                            Εξειδίκευση σε Balayage, Ombre και μοντέρνες χρωματικές αλλαγές με προϊόντα υψηλής ποιότητας για ζωντανά, υγιή μαλλιά.
                        </p>
                        <p>
                            Το Balayage είναι μια τεχνική ελεύθερου χεριού που δημιουργεί φυσικές, sun-kissed ανταύγειες με απαλές μεταβάσεις χρώματος.
                        </p>
                        <p>
                            Από λεπτές, φυσικές ανταύγειες έως δραματικές αλλαγές χρώματος, δημιουργούμε εξατομικευμένα looks που ταιριάζουν στο στυλ και την προσωπικότητά σας.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 bg-neutral-50">
                <div className="container mx-auto px-4 md:px-6">
                    <ImageCarousel
                        images={workImages}
                        title="Δουλειές Balayage"
                        emptyMessage="Προσθέστε φωτογραφίες στον φάκελο public/services/balayage/work για να εμφανιστούν εδώ."
                    />
                </div>
            </section>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4 md:px-6">
                    <ImageCarousel
                        ...
                        emptyMessage="Προσθέστε φωτογραφίες στον φάκελο public/services/balayage/products για να εμφανιστούν εδώ."
                    />
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    <div className="bg-white rounded-3xl shadow-2xl overflow-hidden p-8 md:p-16 text-center max-w-3xl mx-auto">
                        ...
                        <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 text-neutral-900 leading-tight">
                            Έτοιμοι για νέο look;
                        </h2>
                        <p className="text-neutral-600 mb-8 text-lg">
                            Κλείστε το ραντεβού σας σήμερα και ανακαλύψτε τη μαγεία του επαγγελματικού Balayage.
                        </p>
