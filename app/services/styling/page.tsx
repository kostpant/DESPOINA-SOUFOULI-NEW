 ...
 * 
 * 1. Ανοίξτε τον φάκελο: public/services/styling/work/
 * 2. Ανοίξτε τον φάκελο: public/services/styling/products/
...
export default async function StylingPage() {
    const workImages = await getImagesFromFolder("services/styling/work");
    const productImages = await getImagesFromFolder("services/styling/products");
            ...
            <section className="min-h-screen bg-white flex items-center justify-center">
                <div className="container mx-auto px-4 md:px-6 max-w-4xl text-center py-32">
                    ...
                    <div className="text-neutral-600 space-y-4 mx-auto max-w-2xl text-lg md:text-xl leading-relaxed">
                        <p>
                            Χτενίσματα, σινιόν και styling για εκδηλώσεις που θα σας κάνουν να δείχνετε εντυπωσιακή σε κάθε περίσταση.
                        </p>
                        <p>
                            Από κομψά updos για γάμους και επίσημες εκδηλώσεις έως glamorous blow-dry styling για ειδικές βραδιές, δημιουργούμε looks που διαρκούν όλη τη μέρα.
                        </p>
                        <p>
                            Είτε θέλετε ρομαντικά κύματα, sleek και sophisticated styling, ή εντυπωσιακά updos, είμαστε εδώ για να σας κάνουμε να λάμψετε.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 bg-neutral-50">
                <div className="container mx-auto px-4 md:px-6">
                    <ImageCarousel
                        ...
                        emptyMessage="Προσθέστε φωτογραφίες στον φάκελο public/services/styling/work για να εμφανιστούν εδώ."
                    />
                </div>
            </section>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4 md:px-6">
                    <ImageCarousel
                        ...
                        emptyMessage="Προσθέστε φωτογραφίες στον φάκελο public/services/styling/products για να εμφανιστούν εδώ."
                    />
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    <div className="bg-white rounded-3xl shadow-2xl overflow-hidden p-8 md:p-16 text-center max-w-3xl mx-auto">
                        ...
                        <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 text-neutral-900 leading-tight">
                            Έτοιμοι για την ειδική σας εκδήλωση;
                        </h2>
                        <p className="text-neutral-600 mb-8 text-lg">
                            Κλείστε το ραντεβού σας σήμερα και εξασφαλίστε το τέλειο styling.
                        </p>
